...
def test_create_status(job_status_database: JobStatusDatabase):
    status = job_status_database.create_status()
    assert status.id is not None
    assert status.created_at is not None


def test_update_status_to_success(job_status_database: JobStatusDatabase):
    status = job_status_database.create_status()
...
def test_update_status_to_error(job_status_database: JobStatusDatabase):
...
def test_get_all_status(job_status_database: JobStatusDatabase):
...
def test_get_status_valid(job_status_database: JobStatusDatabase):
    status = job_status_database.create_status()
...
def test_delete_status_valid(job_status_database: JobStatusDatabase):
    status = job_status_database.create_status()
